...
@pytest.mark.parametrize(
    ...
    [
        [
            ["--mode", "compress", "-nr", "-br", ".8", "./test/files/M4H01785.mp4"],
            {"fileout": "./test/files/2012.10.21 - M4H01785.fix.comp.mp4", "fator": 0.02},
        ],
        [
            ["--mode", "compress", "-nr", "-br", ".8", "./test/files/2013-01-01.3gp"],
            {"fileout": "./test/files/2013-01-01.fix.comp.mp4", "fator": 0.02},
        ],
    ],
)
def test_compress2_file(GET_MOVIE_INFO, args, output):
    # Arrange
    runner = CliRunner()
